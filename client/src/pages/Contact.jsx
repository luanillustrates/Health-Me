...
export default function Contact() {
  ...
  return (
    <Stack spacing={2}>
      <List marker={type}>
        <ListItem>Mon 9:00 - 16:30</ListItem>
        <ListItem>Tue 9:00 - 16:30</ListItem>
        <ListItem>Wed 9:00 - 16:30</ListItem>
        <ListItem>Thu 9:00 - 16:30</ListItem>
        <ListItem>Fri 9:00 - 16:30</ListItem>
      </List>
      <iframe
